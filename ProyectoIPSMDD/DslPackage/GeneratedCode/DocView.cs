...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	/// </summary>
	internal partial class ANHAMMDRMLenguajeDocView : ANHAMMDRMLenguajeDocViewBase
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeDocView.
		/// </summary>
		public ANHAMMDRMLenguajeDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ANHAMMDRMLenguajeDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeDocView.
		/// </summary>
		protected ANHAMMDRMLenguajeDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ANHAMMDRMLenguajeDocDataBase docData = this.DocData as ANHAMMDRMLenguajeDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ANHAMMDRMLenguajeDocViewBase should be an ANHAMMDRMLenguajeDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ANHAMMDRMLenguajeDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
