...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	/// </summary>
	internal partial class ANHAMMDRMLenguajeExplorer : ANHAMMDRMLenguajeExplorerBase
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeExplorer.
		/// </summary>
		public ANHAMMDRMLenguajeExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the ANHAMMDRMLenguajeExplorerToolWindow.
	/// </summary>
	internal abstract class ANHAMMDRMLenguajeExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeExplorerBase.
		/// </summary>
		protected ANHAMMDRMLenguajeExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.ANHAMMDRMLenguajeExplorerMenu;
			}
		}
		...
		{
			get { return global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.Tapiz.DomainClassId; }
		}
