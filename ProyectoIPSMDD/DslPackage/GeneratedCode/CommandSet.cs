...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	/// </summary>
	internal partial class ANHAMMDRMLenguajeCommandSet : ANHAMMDRMLenguajeCommandSetBase
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeCommandSet.
		/// </summary>
		public ANHAMMDRMLenguajeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ANHAMMDRMLenguajeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeCommandSetBase.
		/// </summary>
		protected ANHAMMDRMLenguajeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewANHAMMDRMLenguajeExplorerCommand,
				typeof(ANHAMMDRMLenguajeEditorFactory).GUID);
		...
		{
			ANHAMMDRMLenguajeExplorerToolWindow explorer = this.ANHAMMDRMLenguajeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ANHAMMDRMLenguajeDocData CurrentANHAMMDRMLenguajeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ANHAMMDRMLenguajeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ANHAMMDRMLenguajeDocView CurrentANHAMMDRMLenguajeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ANHAMMDRMLenguajeDocView;
			}
		}
		...
		/// </summary>
		protected ANHAMMDRMLenguajeExplorerToolWindow ANHAMMDRMLenguajeExplorerToolWindow
		{
			get
			{
				ANHAMMDRMLenguajeExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ANHAMMDRMLenguajeExplorerToolWindow), true) as ANHAMMDRMLenguajeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ANHAMMDRMLenguajeExplorerToolWindow explorerWindow = this.ANHAMMDRMLenguajeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ANHAMMDRMLenguajeClipboardCommandSet : ANHAMMDRMLenguajeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeClipboardCommandSet.
		/// </summary>
		public ANHAMMDRMLenguajeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ANHAMMDRMLenguajeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeClipboardCommandSetBase.
		/// </summary>
		protected ANHAMMDRMLenguajeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
