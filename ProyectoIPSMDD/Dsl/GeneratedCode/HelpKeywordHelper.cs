...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	/// </remarks>
	public partial class ANHAMMDRMLenguajeHelpKeywordHelper : ANHAMMDRMLenguajeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeHelpKeywordHelper.
		/// </summary>
		protected ANHAMMDRMLenguajeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ANHAMMDRMLenguajeHelpKeywordHelper.
		/// </summary>
		public static ANHAMMDRMLenguajeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ANHAMMDRMLenguajeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ANHAMMDRMLenguajeHelpKeywordHelperBase.
		/// </summary>
		protected ANHAMMDRMLenguajeHelpKeywordHelperBase()
			: base() { }
