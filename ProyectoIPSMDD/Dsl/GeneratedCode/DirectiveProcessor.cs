...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides ANHAMMDRMLenguaje files
	/// The implementation is done in ANHAMMDRMLenguajeDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class ANHAMMDRMLenguajeDirectiveProcessor : ANHAMMDRMLenguajeDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ANHAMMDRMLenguajeDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides ANHAMMDRMLenguaje files
	/// </summary>
	public class ANHAMMDRMLenguajeDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string ANHAMMDRMLenguajeDirectiveProcessorName = "ANHAMMDRMLenguajeDirectiveProcessor";
		...
		/// </summary>
		private const string supportedDirectiveName = "ANHAMMDRMLenguaje";
		...
		/// Constructor
		/// </summary>
		public ANHAMMDRMLenguajeDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return ANHAMMDRMLenguajeDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.Tapiz));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.Tapiz));
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"IPS.ANHAMMDRM.ANHAMMDRMLenguaje.ANHAMMDRMLenguajeDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("ANHAMMDRMLenguajeDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("IPS.ANHAMMDRM.ANHAMMDRMLenguaje");
