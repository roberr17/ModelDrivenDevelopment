...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	partial class ANHAMMDRMLenguajeDomainModel
	{
		///<Summary>
		...
		partial void InitializeSerialization(DslModeling::Store store)
		{
			...
			ANHAMMDRMLenguajeSerializationHelper.Instance.InitializeSerialization(store);	
		}
	}
	
	
	/// <summary>
	/// Helper class for serializing and deserializing ANHAMMDRMLenguaje models.
	/// </summary>
	public abstract partial class ANHAMMDRMLenguajeSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected ANHAMMDRMLenguajeSerializationHelperBase() { }
		#endregion
		...
		internal protected virtual void InitializeSerialization(DslModeling::Store store)
		{
			...
			DslModeling::IMonikerResolver monikerResolver = store.FindMonikerResolver(ANHAMMDRMLenguajeDomainModel.DomainModelId);
			if (monikerResolver == null)
			{
				monikerResolver = new ANHAMMDRMLenguajeSerializationBehaviorMonikerResolver(store, directory);
				store.AddMonikerResolver(ANHAMMDRMLenguajeDomainModel.DomainModelId, monikerResolver);
			}
			
			// Add serialization behaviors
			directory.AddBehavior(ANHAMMDRMLenguajeSerializationBehavior.Instance);
		}
	...
	/// Helper class for serializing and deserializing ANHAMMDRMLenguaje models.
	/// </summary>
	public sealed partial class ANHAMMDRMLenguajeSerializationHelper : ANHAMMDRMLenguajeSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private ANHAMMDRMLenguajeSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static ANHAMMDRMLenguajeSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static ANHAMMDRMLenguajeSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (ANHAMMDRMLenguajeSerializationHelper.instance == null)
					ANHAMMDRMLenguajeSerializationHelper.instance = new ANHAMMDRMLenguajeSerializationHelper();
				return ANHAMMDRMLenguajeSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	partial class ANHAMMDRMLenguajeSerializationHelperBase
	{
		...
		public virtual Tapiz LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string location, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator, global::System.IO.Stream stream)
		{
			...
			{
				throw new global::System.InvalidOperationException(ANHAMMDRMLenguajeDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			...
			if (modelRootSerializer != null)
			{
				...
				using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + location ?? "stream", true, transactionContext))
				{
					...
					if (stream.Length > 5)
					{
						try
						{
							global::System.Xml.XmlReaderSettings settings = ANHAMMDRMLenguajeSerializationHelper.Instance.CreateXmlReaderSettings(serializationContext, false);
		...
		internal global::System.IO.MemoryStream InternalSaveModel(DslModeling::SerializationResult serializationResult, Tapiz modelRoot, string fileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			...
			global::System.Xml.XmlWriterSettings settings = ANHAMMDRMLenguajeSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, false, encoding);
		...
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">ANHAMMDRMLenguajeDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="encoding">Encoding to use when saving the diagram.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		/// <returns>In-memory stream containing the serialized ANHAMMDRMLenguajeDiagram instance.</returns>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		internal global::System.IO.MemoryStream InternalSaveDiagram(DslModeling::SerializationResult serializationResult, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			global::System.Diagnostics.Debug.Assert(serializationResult != null);
			...
			// MonikerResolver shouldn't be required in Save operation, so not calling SetupMonikerResolver() here.
			serializationContext.WriteOptionalPropertiesWithDefaultValue = writeOptionalPropertiesWithDefaultValue;
			global::System.Xml.XmlWriterSettings settings = ANHAMMDRMLenguajeSerializationHelper.Instance.CreateXmlWriterSettings(serializationContext, true, encoding);
			using (global::System.Xml.XmlWriter writer = global::System.Xml.XmlWriter.Create(newFileContent, settings))
			{
		...
		/// <param name="diagramFileName">Name of the file from which the ANHAMMDRMLenguajeDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		/// </param>
		...
		/// <param name="modelFileName">Name of the file from which the Tapiz instance will be deserialized.</param>
		/// <param name="diagramPartition">Partition in which the new ANHAMMDRMLenguajeDiagram instance will be created.</param>
		/// <param name="diagramFileName">Name of the file from which the ANHAMMDRMLenguajeDiagram instance will be deserialized.</param>
		/// <param name="schemaResolver">
		/// An ISchemaResolver that allows the serializer to do schema validation on the root element (and everything inside it).
		/// If null is passed, schema validation will not be performed.
		...
		public virtual Tapiz LoadModelAndDiagram(DslModeling::SerializationResult serializationResult, DslModeling::Partition modelPartition, string modelFileName, DslModeling::Partition diagramPartition, string diagramFileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController, DslModeling::ISerializerLocator serializerLocator)
		{
			...
			ANHAMMDRMLenguajeDiagram diagram = null;
			DslModeling::DomainXmlSerializerDirectory directory = this.GetDirectory(diagramPartition.Store);
			DslModeling::DomainClassXmlSerializer diagramSerializer = directory.GetSerializer(ANHAMMDRMLenguajeDiagram.DomainClassId);
			global::System.Diagnostics.Debug.Assert(diagramSerializer != null, "Cannot find serializer for ANHAMMDRMLenguajeDiagram");
						...
						using (DslModeling::Transaction t = diagramPartition.Store.TransactionManager.BeginTransaction("LoadDiagram", true, transactionContext))
						{
							...
							if (fileStream.Length > 5)
							{
								...
								try
								{
									...
									{
										reader.MoveToContent();
										diagram = diagramSerializer.TryCreateInstance(serializationContext, reader, diagramPartition) as ANHAMMDRMLenguajeDiagram;
										if (diagram != null)
										{
		...
		/// <summary>
		/// Helper method to create and initialize a new ANHAMMDRMLenguajeDiagram.
		/// </summary>
		...
		internal protected virtual ANHAMMDRMLenguajeDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			ANHAMMDRMLenguajeDiagram diagram = new ANHAMMDRMLenguajeDiagram(diagramPartition);
			return diagram;
		}
		...
		/// <param name="diagram">ANHAMMDRMLenguajeDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Tapiz modelRoot, string modelFileName, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Tapiz modelRoot, string modelFileName, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given Tapiz and ANHAMMDRMLenguajeDiagram to the given files, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="modelRoot">Tapiz instance to be saved.</param>
		/// <param name="modelFileName">Name of the file in which the CanonicalSampleRoot instance will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveModelAndDiagram(DslModeling::SerializationResult serializationResult, Tapiz modelRoot, string modelFileName, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		/// <param name="diagram">ANHAMMDRMLenguajeDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName)
		{
		...
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName, bool writeOptionalPropertiesWithDefaultValue)
		{
		...
		/// <summary>
		/// Saves the given ANHAMMDRMLenguajeDiagram to the given file, with specified encoding.
		/// </summary>
		/// <param name="serializationResult">Stores serialization result from the save operation.</param>
		/// <param name="diagram">ANHAMMDRMLenguajeDiagram to be saved.</param>
		/// <param name="diagramFileName">Name of the file in which the diagram will be saved.</param>
		...
		/// <param name="writeOptionalPropertiesWithDefaultValue">Whether optional properties with default value will be saved.</param>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1011:ConsiderPassingBaseTypesAsParameters")]
		public virtual void SaveDiagram(DslModeling::SerializationResult serializationResult, ANHAMMDRMLenguajeDiagram diagram, string diagramFileName, global::System.Text.Encoding encoding, bool writeOptionalPropertiesWithDefaultValue)
		{
			#region Check Parameters
			if (serializationResult == null)
				throw new global::System.ArgumentNullException("serializationResult");
		...
		public virtual void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement rootElement, global::System.Xml.XmlWriter writer)
		{
			...
			if (!(rootElement is DslDiagrams::Diagram))
			{
				...
				rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/ANHAMMDRMLenguaje";
			}
		...
		protected virtual void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						ANHAMMDRMLenguajeSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					ANHAMMDRMLenguajeSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		protected virtual global::System.Xml.XmlReader TryCreateValidatingReader(DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (success && schemaSet.Count > 0)
			{
				...
				ANHAMMDRMLenguajeSerializationBehaviorSchemaValidationCallback validationCallback = new ANHAMMDRMLenguajeSerializationBehaviorSchemaValidationCallback(serializationContext);
		...
		protected static bool ResolveSchema(string targetNamespace, global::System.Xml.Schema.XmlSchemaSet schemaSet, DslModeling::ISchemaResolver schemaResolver, global::System.Xml.XmlReader reader, DslModeling::SerializationContext serializationContext)
		{
			...
			if (schemas != null && schemas.Count > 0)
			{
				if (schemas.Count > 1)
				{
					ANHAMMDRMLenguajeSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
				}
				schemaSet.Add(targetNamespace, schemas[0]);
				return true;
			}
	
			ANHAMMDRMLenguajeSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
			return false;
		}
		...
		/// </summary>
		private sealed class ANHAMMDRMLenguajeSerializationBehaviorSchemaValidationCallback
		{
			...
			internal ANHAMMDRMLenguajeSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					ANHAMMDRMLenguajeSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public virtual string GetSerializedModelString(global::IPS.ANHAMMDRM.ANHAMMDRMLenguaje.Tapiz modelRoot, global::System.Text.Encoding encoding)
		{
...
namespace IPS.ANHAMMDRM.ANHAMMDRMLenguaje
{
	...
	public partial class Tapiz
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = ANHAMMDRMLenguajeSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									ANHAMMDRMLenguajeDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
